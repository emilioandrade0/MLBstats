...
const tabs = [
  ...
  { id: 'riesgo', label: 'Fallos y riesgo', icon: ShieldCheck, title: 'Aprender de cada fallo.', description: 'Compara señales, aciertos y cobertura antes de cambiar tus picks.', sections: ['riesgo'] },
