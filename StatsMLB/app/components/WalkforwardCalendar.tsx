...
export default function WalkforwardCalendar({ active, onToggle, onSetActive }: WalkforwardCalendarProps) {
  ...
  return (
    <>
      ...
      <div className="wf-method-legend" role="note"><ShieldCheck size={15} /><span><strong>Predicción congelada:</strong> cada día conserva el modelo que existía antes de sus juegos.</span><span><strong>Lectura:</strong> selecciona una fecha para contrastar pick, resultado y corte de entrenamiento.</span></div>
